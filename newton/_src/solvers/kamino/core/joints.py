...
#     eio = world_joint_cts_offsets[wid]
...
#     eio_j += eio
#     for j in range(e_j):
#         state_joint_r_j[eio_j + j] = 0.0
#         state_joint_dr_j[eio_j + j] = 0.0
