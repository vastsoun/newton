...
class Example:
    def __init__(self, viewer: newton.viewer.ViewerBase, args=None):
        ...
        def make_dr_legs_builder(usd_asset, builder: newton.ModelBuilder) -> newton.ModelBuilder:
        ...
        # TODO
        usd_asset = get_usd_stage_dr_legs()
        builder_fn = functools.partial(make_dr_legs_builder, usd_asset)
        builder_kwargs = None
        model_kwargs = None
    ...
    def create_parser():
        ...
        parser.set_defaults(standalone=True, headless=True, animation=False, leader="kamino")
        return parser
