...
class Example:
    def __init__(self, viewer: newton.viewer.ViewerBase, args=None):
        ...
        def make_dr_legs_builder(builder: newton.ModelBuilder) -> newton.ModelBuilder:
            ...
            asset_file = "D:/gmaloisel/Documents/Quick access shortcuts/Kamino - Data/kamino-assets-disney/usda/Olaf/olaf_articulated.usda"
            builder.add_usd(
                asset_file,
        ...
        solver_kamino_cfg.padmm.max_iterations = 400
        ...
        solver_xpbd_kwargs = {
            ...
            "joint_linear_compliance": 1e-6,
            "joint_angular_compliance": 1e-6,
