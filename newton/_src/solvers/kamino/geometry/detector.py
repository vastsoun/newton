...
from ..geometry.contacts import DEFAULT_GEOM_PAIR_CONTACT_GAP, DEFAULT_GEOM_PAIR_MAX_CONTACTS, ContactsKamino
...
class CollisionDetector:
    ...
    def model_max_contacts(self) -> int:
        ...
        return self._contacts.model_max_contacts_host if self._contacts is not None else 0

    @property
    def world_max_contacts(self) -> list[int]:
        """Returns the maximum number of contacts allocated for each world."""
        return self._contacts.world_max_contacts_host if self._contacts is not None else []

    @property
    def contacts(self) -> ContactsKamino:
    ...
    def finalize(
        ...
        self._contacts = ContactsKamino(capacity=world_max_contacts, device=self._device)
    ...
    def collide(self, model: ModelKamino, data: DataKamino, contacts: ContactsKamino | None = None):
        """
