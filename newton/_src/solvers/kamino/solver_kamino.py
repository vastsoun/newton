...
class SolverKamino(SolverBase):
    ...
    def reset(
        ...
        self._solver_kamino.reset(
            state_out=self._kamino.StateKamino.from_newton(self._model_kamino.size, self.model, state_out),
    ...
    def step(self, state_in: State, state_out: State, control: Control, contacts: Contacts, dt: float):
        ...
        self._kamino.compute_body_com_state(
        ...
        self._kamino.compute_body_frame_state(
            body_com=self._model_kamino.bodies.i_r_com_i,
            body_q_com=state_in_kamino.q_i,
            body_q=state_in_kamino.q_i,
        )
