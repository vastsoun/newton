...
class TestSimulator(unittest.TestCase):
    ...
    def test_step_simulator(self):
        ...
        if self.verbose:
            ...
            print(f"[post-step]: sim.collision_detector.collisions.cstate.model_num_collisions: {sim.collision_detector.collisions.cstate.model_num_collisions}")
            print(f"[post-step]: sim.collision_detector.collisions.cstate.world_num_collisions: {sim.collision_detector.collisions.cstate.world_num_collisions}")
            print(f"[post-step]: sim.collision_detector.collisions.cstate.wid: {sim.collision_detector.collisions.cstate.wid}")
            print(f"[post-step]: sim.collision_detector.collisions.cstate.geom_pair:\n{sim.collision_detector.collisions.cstate.geom_pair}")
