...
class TestSolverMetrics(unittest.TestCase):
    ...
    def test_05_compare_dense_sparse_padmm_solution_boxes_hinged(self):
        ...
        np.testing.assert_allclose(metrics_np["r_v_plus"], metrics_sparse.data.r_v_plus.numpy(), rtol=rtol, atol=atol)
        np.testing.assert_allclose(metrics_np["f_ccp"], metrics_sparse.data.f_ccp.numpy(), rtol=rtol, atol=atol)
        np.testing.assert_allclose(metrics_np["f_ncp"], metrics_sparse.data.f_ncp.numpy(), rtol=rtol, atol=atol)
        np.testing.assert_allclose(
            metrics_np["r_ncp_p"], metrics_sparse.data.r_ncp_primal.numpy(), rtol=rtol, atol=atol
        )
