...
class TestUSDImporter(unittest.TestCase):
    ...
    def test_import_joint_cylindrical_passive_unary(self):
        ...
        self.assertEqual(builder_usd.num_joints, 1)
        self.assertEqual(builder_usd.joints[0][0].act_type, JointActuationType.PASSIVE)
        self.assertEqual(builder_usd.joints[0][0].dof_type, JointDoFType.D6)
        self.assertEqual(builder_usd.joints[0][0].dof_dim, (1, 1))
        self.assertEqual(builder_usd.joints[0][0].wid, 0)
        self.assertEqual(builder_usd.joints[0][0].jid, 0)
        self.assertEqual(builder_usd.joints[0][0].bilateral_cts_offset, 0)
        self.assertEqual(builder_usd.joints[0][0].dofs_offset, 0)
    ...
    def test_import_joint_d6_universal_passive(self):
        ...
        self.assertEqual(builder_usd.joints[0][0].act_type, JointActuationType.PASSIVE)
        self.assertEqual(builder_usd.joints[0][0].dof_type, JointDoFType.D6)
        self.assertEqual(builder_usd.joints[0][0].dof_dim, (0, 2))
        self.assertEqual(builder_usd.joints[0][0].wid, 0)
        self.assertEqual(builder_usd.joints[0][0].jid, 0)
        self.assertEqual(builder_usd.joints[0][0].bilateral_cts_offset, 0)
        self.assertEqual(builder_usd.joints[0][0].dofs_offset, 0)
    ...
    @unittest.skipUnless(USD_AVAILABLE, "Requires usd-core")
    def test_import_joint_d6_rejects_partial_drives(self):
        """Reject D6 actuation that does not cover every free DoF."""
        from pxr import Usd, UsdPhysics

        usd_asset_filename = get_kamino_testing_asset("joints/test_joint_d6_universal_actuated.usda")
        stage = Usd.Stage.Open(usd_asset_filename)
        joint = stage.GetPrimAtPath("/test_joint_d6_universal_actuated/Joints/actuated_d6_universal_joint")
        self.assertTrue(joint.RemoveAPI(UsdPhysics.DriveAPI, "rotY"))

        with self.assertRaisesRegex(ValueError, "exactly one drive for each free DoF"):
            USDImporter().import_from(source=stage)
    ...
    def test_import_joint_d6_cartesian_passive(self):
        ...
        self.assertEqual(builder_usd.joints[0][0].act_type, JointActuationType.PASSIVE)
        self.assertEqual(builder_usd.joints[0][0].dof_type, JointDoFType.D6)
        self.assertEqual(builder_usd.joints[0][0].dof_dim, (3, 0))
        self.assertEqual(builder_usd.joints[0][0].wid, 0)
        self.assertEqual(builder_usd.joints[0][0].jid, 0)
        self.assertEqual(builder_usd.joints[0][0].bilateral_cts_offset, 0)
        self.assertEqual(builder_usd.joints[0][0].dofs_offset, 0)
    ...
    def test_import_joint_d6_spherical_passive(self):
        ...
        self.assertEqual(builder_usd.joints[0][0].act_type, JointActuationType.PASSIVE)
        self.assertEqual(builder_usd.joints[0][0].dof_type, JointDoFType.D6)
        self.assertEqual(builder_usd.joints[0][0].dof_dim, (0, 3))
        self.assertEqual(builder_usd.joints[0][0].wid, 0)
        self.assertEqual(builder_usd.joints[0][0].jid, 0)
        self.assertEqual(builder_usd.joints[0][0].bilateral_cts_offset, 0)
        self.assertEqual(builder_usd.joints[0][0].dofs_offset, 0)
    ...
    def test_import_model_dr_testmech(self):
        ...
        self.assertEqual(builder_usd.joints[0][3].dof_type, JointDoFType.D6)
        ...
        self.assertEqual(builder_usd.joints[0][6].dof_type, JointDoFType.D6)
        ...
        self.assertEqual(builder_usd.joints[0][8].dof_type, JointDoFType.D6)
        ...
        self.assertEqual(builder_usd.joints[0][13].dof_type, JointDoFType.D6)
