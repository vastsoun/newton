...
class TestUtilsLinAlgLinearSolvers(unittest.TestCase):
    ...
    def test_01_defaulted_numpy_solver(self):
        ...
        msg.debug(f"NumPySolver: error_abs: {solver.error_abs}")
        msg.debug(f"NumPySolver: error_rel: {solver.error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
    ...
    def test_03_defaulted_scipy_solver(self):
        ...
        msg.debug(f"SciPySolver: error_abs: {solver.error_abs}")
        msg.debug(f"SciPySolver: error_rel: {solver.error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertTrue(np.allclose(x, self.x_ref, atol=self.atol, rtol=self.rtol))
    ...
    def test_05_defaulted_llt_numpy_solver(self):
        ...
        msg.debug(f"LLTNumPySolver: error_abs: {solver.error_abs}")
        msg.debug(f"LLTNumPySolver: error_rel: {solver.error_rel}")
        msg.debug(f"LLTNumPySolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LLTNumPySolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
        self.assertTrue(np.allclose(x, self.x_ref, atol=self.atol, rtol=self.rtol))
    ...
    def test_07_defaulted_llt_scipy_solver(self):
        ...
        msg.debug(f"LLTSciPySolver: error_abs: {solver.error_abs}")
        msg.debug(f"LLTSciPySolver: error_rel: {solver.error_rel}")
        msg.debug(f"LLTSciPySolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LLTSciPySolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    def test_09_defaulted_ldlt_scipy_solver(self):
        ...
        msg.debug(f"LDLTSciPySolver: error_abs: {solver.error_abs}")
        msg.debug(f"LDLTSciPySolver: error_rel: {solver.error_rel}")
        msg.debug(f"LDLTSciPySolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LDLTSciPySolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    def test_11_defaulted_lu_scipy_solver(self):
        ...
        msg.debug(f"LUSciPySolver: error_abs: {solver.error_abs}")
        msg.debug(f"LUSciPySolver: error_rel: {solver.error_rel}")
        msg.debug(f"LUSciPySolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LUSciPySolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    def test_13_jacobi_solver(self):
        ...
        msg.debug(f"JacobiSolver: error_abs: {solver.error_abs}")
        msg.debug(f"JacobiSolver: error_rel: {solver.error_rel}")
    ...
    def test_14_gauss_seidel_solver(self):
        ...
        msg.debug(f"GaussSeidelSolver: error_abs: {solver.error_abs}")
        msg.debug(f"GaussSeidelSolver: error_rel: {solver.error_rel}")
    ...
    def test_15_successive_over_relaxation_solver(self):
        ...
        msg.debug(f"SORSolver: error_abs: {solver.error_abs}")
        msg.debug(f"SORSolver: error_rel: {solver.error_rel}")
    ...
    def test_16_conjugate_gradient_solver(self):
        ...
        msg.debug(f"ConjugateGradientSolver: error_abs: {solver.error_abs}")
        msg.debug(f"ConjugateGradientSolver: error_rel: {solver.error_rel}")
    ...
    def test_17_minimum_residual_solver(self):
        ...
        msg.debug(f"MinimumResidualSolver: error_abs: {solver.error_abs}")
        msg.debug(f"MinimumResidualSolver: error_rel: {solver.error_rel}")
    ...
    def test_18_llt_std_solver(self):
        ...
        msg.debug(f"LLTStdSolver: error_abs: {solver.error_abs}")
        msg.debug(f"LLTStdSolver: error_rel: {solver.error_rel}")
        msg.debug(f"LLTStdSolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LLTStdSolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    def test_19_ldlt_nopivot_solver(self):
        ...
        msg.debug(f"LDLTNoPivotSolver: error_abs: {solver.error_abs}")
        msg.debug(f"LDLTNoPivotSolver: error_rel: {solver.error_rel}")
        msg.debug(f"LDLTNoPivotSolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LDLTNoPivotSolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    def test_20_ldlt_blocked_solver(self):
        ...
        msg.debug(f"LDLTBlockedSolver: error_abs: {solver.error_abs}")
        msg.debug(f"LDLTBlockedSolver: error_rel: {solver.error_rel}")
        msg.debug(f"LDLTBlockedSolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LDLTBlockedSolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    #     msg.debug(f"LDLTBunchKaufmanSolver: error_abs: {solver.error_abs}")
    #     msg.debug(f"LDLTBunchKaufmanSolver: error_rel: {solver.error_rel}")
    #     msg.debug(f"LDLTBunchKaufmanSolver: factorization_error_abs: {solver.factorization_error_abs}")
    #     msg.debug(f"LDLTBunchKaufmanSolver: factorization_error_rel: {solver.factorization_error_rel}\n")
    #     self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
    #     self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
    #     self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
    #     self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    def test_22_ldlt_eigen3_solver(self):
        ...
        msg.debug(f"LDLTEigen3Solver: error_abs: {solver.error_abs}")
        msg.debug(f"LDLTEigen3Solver: error_rel: {solver.error_rel}")
        msg.debug(f"LDLTEigen3Solver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LDLTEigen3Solver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
    ...
    def test_23_lu_nopivot_solver(self):
        ...
        msg.debug(f"LUNoPivotSolver: error_abs: {solver.error_abs}")
        msg.debug(f"LUNoPivotSolver: error_rel: {solver.error_rel}")
        msg.debug(f"LUNoPivotSolver: factorization_error_abs: {solver.factorization_error_abs}")
        msg.debug(f"LUNoPivotSolver: factorization_error_rel: {solver.factorization_error_rel}\n")
        self.assertAlmostEqual(solver.error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.error_rel, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_abs, 0.0, places=6)
        self.assertAlmostEqual(solver.factorization_error_rel, 0.0, places=6)
