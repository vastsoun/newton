...
def extract_cts_jacobians(
    ...
    for i in range(num_jacobians):
        ...
        J_cts_mat.append(J_cts_flat[J_cts_flat_offsets[i]:J_cts_flat_offsets[i] + J_cts_flat_sizes[i]].reshape(J_cts_flat_shapes[i])[:J_rows, :J_cols])
...
def extract_dofs_jacobians(
    ...
    for i in range(num_jacobians):
        ...
        J_cts_mat.append(J_dofs_flat[J_dofs_flat_offsets[i]:J_dofs_flat_offsets[i] + J_dofs_flat_sizes[i]].reshape(J_dofs_flat_shapes[i])[:J_rows, :J_cols])
