...
class TestDistributeTotalByWeights(unittest.TestCase):
    ...
    def test_distribution_preserves_total(self):
        ...
        self.assertEqual(sum(distribute_total_by_weights([2, 3, 5], 100)), 100)
        self.assertEqual(sum(distribute_total_by_weights([1, 1, 1], 10)), 10)
        self.assertEqual(sum(distribute_total_by_weights([100, 50, 50], 120)), 120)

    def test_scale_down_matches_legacy_cap(self):
        """Legacy proportional cap behavior is preserved for down-scaling."""
        result = distribute_total_by_weights([100, 50, 50], 120)
    ...
    def test_zero_total_zeroes_all_worlds(self):
        ...
        self.assertEqual(distribute_total_by_weights([1, 2, 3], 0), [0, 0, 0])
    ...
    def test_all_zero_weights_produce_equal_split(self):
        ...
        result = distribute_total_by_weights([0, 0, 0], 9)
    ...
    def test_all_zero_weights_with_remainder(self):
        ...
        result = distribute_total_by_weights([0, 0, 0], 10)
